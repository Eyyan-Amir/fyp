...
import { handleSearch, updateJobs, resetJobs } from "../../redux/reducer/reducer";
import { useDispatch, useSelector } from 'react-redux';
import { ENTER_KEY, JOBS } from '../../utlis/constants';
    ...
    <div className="banner">
      ...
      <div className='wrapper'>
        ...
        <div className='search-bar'>
          ...
          {isReset && <Button variant="outlined" onClick={resetFilter}>Reset</Button>}
        </div>
      </div>
    </div>
  )
